...
| Ago/2026 | **Restore marketing PGRST204:** `saveCase` upsertava `toJson()` com chaves ausentes no live. Colunas adicionadas no live + whitelist `toRemoteRow` PR #84 `d7582c1`. Carteira/relatórios já alinhados. Itens 6–8 do checklist ainda 0 (falta publicar no IPA 227 e wipe-prova). |
