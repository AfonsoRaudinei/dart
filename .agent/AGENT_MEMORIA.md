...
| Ago/2026 | **Restore pós-reinstall:** hydrate login + relatórios/marketing/carteira na `main` (PR #67 `94a8ddc`, #68 `173ce7b`). SQL carteira **aplicado no live** `pyoejhhkjlrjijiviryq` (migration remota `20260822223918` `carteira_remote_sync`). Checklist vivo: `.agent/CHECKLIST_RESTORE_REINSTALL.md`. Falta QA desinstalar/reinstalar no aparelho. Hot restart não basta. |
