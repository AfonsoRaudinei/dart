...
- IPA 190: `build/ios/ipa/soloforte_app.ipa` | `CFBundleVersion=190` | `CFBundleShortVersionString=1.34.0` | `MinimumOSVersion=15.0` Runner + App.framework | `./tool/release_store_check.sh` Exit 0 | branch `main` @ `afe0729` | BUG-03 settings Meu Plano nav · BUG-04 planos CTA nav + copy iOS · P0-1 mirror tolerance · P0-3 bundle ID `com.soloforte.soloforteApp` | **enviar este**
