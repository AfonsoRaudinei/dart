...
- IPA 192: pendente | `pubspec 1.34.0+192` | branch `cursor/carteira-finalize-618c` | gráfico geral Oportunidades (toggle Categoria/Produtor) + lista produtores + SmartButton pop/fallback map + valor grão inline
