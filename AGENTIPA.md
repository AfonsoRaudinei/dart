...
- IPA 181: `build/ios/ipa/soloforte_app.ipa` | `CFBundleVersion=181` | `CFBundleShortVersionString=1.34.0` | `SUPABASE_URL` confirmada no binário | branch `cursor/map-navigation-labels-17d6` @ `b7d66ca` | A→D unificado (clima gradientes + labels hybrid + busca município + divisas UF) · PR #22 | **enviar este**
