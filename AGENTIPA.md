...
- IPA 180: `build/ios/ipa/soloforte_app.ipa` | `CFBundleVersion=180` | `CFBundleShortVersionString=1.34.0` | `SUPABASE_URL` confirmada no binário (`pyoejhhkjlrjijiviryq`) | branch `cursor/marketing-case-story-3d34` @ `19b8f0f`+ | PR #21 + `build_testflight.sh` hardened | **enviar este** (179 já consumido no ASC)
