...
- IPA 173: `build/ios/ipa/soloforte_app.ipa` | `CFBundleVersion=173` | `CFBundleShortVersionString=1.34.0` | sketch vertex drag + handle azul (pingo d'água) | pendente validação pós-build
