...
/// Status visual do radar no mapa foi unificado no indicador de conectividade
/// (`MapControlsOverlay` → vermelho/verde/azul Samsung). Mantido como no-op
/// para não quebrar imports/testes legados que ainda referenciam o tipo.
